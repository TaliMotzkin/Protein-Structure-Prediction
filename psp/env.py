...
class ProteinStructureEnv:
    ...
    def render(self):
        ...
        ax.annotate('Start', xy=(0,0), xytext=(0.1, -0.35), color='white', weight='bold')
        ax.annotate('End', xy=self.loc, xytext=(self.loc[0]+0.1, self.loc[1]-0.35), color='white', weight='bold')
